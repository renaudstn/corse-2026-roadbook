window.CORSE2026 = {
  ...
  logistics: [
    ...
    {
      title: "Carburant",
      text: "Plein avant la montée vers Évisa et le 7 août avant Corte. Après Roccapina (15), préparer la station de restitution du 16.",
    },
    {
      title: "Courses",
  ...
  days: [
    ...
    },
    {
      ...
      enrich:
        "On récupère une fin de journée qui était calme : aucune visite majeure n’est sacrifiée. Sartène = visage patrimoine du sud, complémentaire de Corte.",
      why: 'Après Bonifacio, journée tampon côte + village : Campomoro pour mer et marche courte, Sartène en fin d’après-midi pour le centre historique sans forcer la chaleur de midi.',
      metrics: [
    ...
    },
    {
      ...
      short: "Roccapina",
      baseId: "abbartello",
      vibe: "Dernière sortie paysage",
      intensity: 3,
      tags: ["plage", "15 août"],
      summary:
        "Départ tôt pour Roccapina avant l'affluence du 15 août. Sartène a été faite la veille au soir — après-midi légère pour préparer le départ du 16.",
      enrich:
        "Préparer dès le retour : niveaux, déchets, linge, eau, documents, carburant, adresse restitution. Coucher raisonnable.",
      why: 'Dernière sortie « paysage » sans surcharge : Roccapina pour le site ; le patrimoine (Sartène) est déjà calé la veille. Le 15 août impose un départ tôt.',
      metrics: [
        { label: "Route", value: "~110 km" },
        { label: "Conduite", value: "~2 h 20" },
      ...
      timeline: [
        ...
        { time: "07:30", title: "Départ Abbartello", detail: "Via Sartène (passage) puis Roccapina." },
        { time: "09:00", title: "Roccapina", detail: "Belvédère ; plage si piste OK pour la voiture." },
        { time: "09:20", title: "Plage / marche courte", detail: "Jusqu'à midi–13 h ; eau et ombre prioritaires." },
        { time: "13:30", title: "Déjeuner", detail: "Sur place ou pique-nique selon affluence." },
        { time: "15:00", title: "Départ retour", detail: "Vers Abbartello — éviter la saturation retour." },
        { time: "16:30", title: "Camping", detail: "Rangement final du séjour." },
        { time: "19:00", title: "Dernière soirée", detail: "Dîner simple, coucher raisonnable." },
      ],
      remember: "Ne pas engager le camping-car. Sartène = veille (d14), pas à refaire en force.",
      vigilance: "Le 15 août peut être très chargé. Anticiper parking et chaleur.",
      planB: "Belvédère Roccapina uniquement + plage de repli (Cupabia / Abbartello).",
      mapMarkers: ["abbartello", "roccapina"],
      mapZoom: 9,
      ...
      maps: "https://www.google.com/maps/dir/Olmeto-Plage/Roccapina",
    },
    {
      id: "d16",
      date: "2026-08-16",
